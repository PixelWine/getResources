/*
 * @Autor: PixelWine
 * @Date: 2020-06-19 22:29:51
 * @LastEditors: PixelWine
 * @LastEditTime: 2020-09-30 22:04:18
 * @description: 
 */ 
/*
#include <Windows.h>
...
int main()
{
	...
	strcat(buffer, "//1.svg");
	HRESULT Result = URLDownloadToFileA(NULL, "https://aizz.cloudstudio.net/dashboard/media/logo.5395cf9e.svg", buffer, 0, NULL);
	switch (Result)
	{
